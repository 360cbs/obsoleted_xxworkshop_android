...
public abstract class Element {
    ...
    protected void initView() {
        ...
        XXRect rect = XXFormatter.convertRect(new XXRect(state.x, state.y, state.w, state.h), state.anchor);
    ...
    public void OnTouchMove(int step, float delta) {
        ...
        XXRect startRect = XXFormatter.convertRect(new XXRect(startState.x, startState.y, startState.w, startState.h), startState.anchor);
        XXRect endRect = XXFormatter.convertRect(new XXRect(endState.x, endState.y, endState.w, endState.h), endState.anchor);
